...
crudini --set /etc/glance/glance-api.conf keystone_authtoken project_domain_id $keystonedomain
crudini --set /etc/glance/glance-api.conf keystone_authtoken user_domain_id $keystonedomain
...
crudini --set /etc/glance/glance-registry.conf keystone_authtoken project_domain_id $keystonedomain
crudini --set /etc/glance/glance-registry.conf keystone_authtoken user_domain_id $keystonedomain
