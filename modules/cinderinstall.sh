...
crudini --set /etc/cinder/cinder.conf keystone_authtoken project_domain_id $keystonedomain
crudini --set /etc/cinder/cinder.conf keystone_authtoken user_domain_id $keystonedomain
