...
crudini --set /etc/sahara/sahara.conf keystone_authtoken project_domain_id $keystonedomain
crudini --set /etc/sahara/sahara.conf keystone_authtoken user_domain_id $keystonedomain
