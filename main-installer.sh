...
# Version: 1.0.6.ub1404lts "Nuclear Lynx"
# February 21, 2016
#
...
"install")
	...
	echo "- Ubuntu Cloud Archive OpenStack-LIBERTY repository must be enabled and available"
